...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ServerlessOrchestrationApp
...
func newPodForCR(cr *appv1alpha1.ServerlessOrchestrationApp) *corev1.Pod {
